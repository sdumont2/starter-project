 ...
 */
public class SpringClassFileTransformerAdapter implements ClassFileTransformer {

    private static final Log logger = LogFactory.getLog(SpringClassFileTransformerAdapter.class);
    ...
    public SpringClassFileTransformerAdapter(ClassTransformer classTransformer) {
    ...
    public String toString() {
        return "Spring ClassFileTransformer wrapping JPA transformer: " + this.classTransformer;
    }
