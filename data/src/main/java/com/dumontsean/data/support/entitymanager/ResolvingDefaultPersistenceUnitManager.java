...
public class ResolvingDefaultPersistenceUnitManager
    ...
    public void preparePersistenceUnitInfos() {
        ...
        List<MutableSpringPersistenceUnitInfo> puis = readPersistenceUnitInfos();
        for (MutableSpringPersistenceUnitInfo pui : puis) {
     ...
     */
    private List<MutableSpringPersistenceUnitInfo> readPersistenceUnitInfos() {
        ...
        SpringPersistenceUnitReader reader = new SpringPersistenceUnitReader(this.resourcePatternResolver, this.dataSourceLookup, this.environment);
        MutableSpringPersistenceUnitInfo[] readInfos = reader.readPersistenceUnitInfos(this.persistenceXmlLocations);
        for (MutableSpringPersistenceUnitInfo readInfo : readInfos) {
            infos.add(readInfo);
     ...
     * @see #setPackagesToScan
     */
    private MutableSpringPersistenceUnitInfo buildDefaultPersistenceUnitInfo() {
        MutableSpringPersistenceUnitInfo scannedUnit = new MutableSpringPersistenceUnitInfo();
                ...
                if (scannedUnit.getPersistenceUnitRootUrl() == null) {
                    try {
                        scannedUnit.setPersistenceUnitRootUrl(
                                SpringPersistenceUnitReader.determinePersistenceUnitRootUrl(ormXml));
                    }
    ...
    private void scanPackage(MutableSpringPersistenceUnitInfo scannedUnit, String pkg) {
